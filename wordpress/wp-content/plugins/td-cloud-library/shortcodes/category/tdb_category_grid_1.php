    ...
    public function get_custom_css() {
        ...
        $raw_css =
            "<style>
				...
				/* @overlay_1 */
				.$unique_block_class .td_module_wrap:nth-child(4n+1) .td-image-wrap:before {
				    content: '';
				...
				/* @overlay_2 */
				.$unique_block_class .td_module_wrap:nth-child(4n+2) .td-image-wrap:before {
				    content: '';
				...
				/* @overlay_3 */
				.$unique_block_class .td_module_wrap:nth-child(4n+3) .td-image-wrap:before {
				    content: '';
				...
				/* @overlay_4 */
				.$unique_block_class .td_module_wrap:nth-child(4n+4) .td-image-wrap:before {
				    content: '';
