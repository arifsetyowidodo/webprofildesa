    ...
    public function __construct() {
        ...
        $this->category_breadcrumbs = function ( $atts ) {
            ...
            if ( !empty( $category_1_name ) ) {
                ...
                $child_category_custom_title_att = ( $atts['child_category_custom_title_att'] != '' ) ? $atts['child_category_custom_title_att'] : __td( 'View all posts in', TD_THEME_NAME ) . ' ' . htmlspecialchars( $child_category_custom_title );
                $child_category_custom_link = ( $atts['child_category_custom_link'] != '' ) ? $atts['child_category_custom_link'] : $category_1_url;
